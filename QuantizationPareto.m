...
[error_signal_EXACT, quantized_output_EXACT] = DAC5_fixed(audio_signal, N, bits, bits, a, b, g, c);
...
title(["Pareto front for all pairs of coefficinet/internal wordlengths", sprintf("s.t. the FxP DAC-5 output coincides with the float %d DAC-5", bits), "OSR: " + OSR])
